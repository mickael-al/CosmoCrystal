...
* #### Combat :
	...
	* ##### level design :
		...
		* énigmes :
			...
			* <strong>fossé franchissable avec grappin</strong> : le joueur peut passer de l'autre côté d'un fossé via un grappin.
			* <strong>Interupteur(Switch)</strong> : le joueur peut activer des interupteur pour ouvrir des portes.
			* <strong>blocks/physique</strong> : le joueur peut déplacer des blocs de pierre pour activer des mécanismes.
			* <strong>Control Mental</strong> : le Joueur peut prendre le contrôle de petite araignée qu'il peut contrôler dans des petites zones. 
	* ##### items et marchands :
		* items :
			* <strong>items de buff</strong> : le joueur pourra acheter des objets spéciaux à des marchands, il pourra en porter un au maximum et  il lui donnerons un buff au détriment d'un débuff. 
## Histoire
* #### Contexte :
